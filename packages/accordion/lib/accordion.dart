...
class Accordion extends StatelessWidget with CommonParams {
  ...
  Accordion({
    ...
    this.paddingListTop = 10.0,
    this.paddingListBottom = 0.0,
    this.paddingListHorizontal = 0.0,
    ...
    this.headerBackgroundOpened =
        headerBackgroundOpened ?? headerBackground;
    ...
    this.contentBorderRadius = contentBorderRadius ?? 0;
    ...
    this.paddingBetweenOpenSections = paddingBetweenOpenSections ?? 0;
      ...
      itemBuilder: (context, index) {
        ...
        return AutoScrollTag(
          ...
          child: AccordionSection(
            ...
            headerBackgroundOpened: child.headerBackgroundOpened ??
                headerBackgroundOpened ??
                headerBackground,
