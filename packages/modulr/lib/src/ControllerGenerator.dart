...
import 'package:modulr/Module/controllers/ModuleSingleController.dart'
    as modulrController;
...
Future<void> generateController() async {
  ...
  String _controllerFile = modulrController.stub.replaceAll(
      '{MODULE}', Utils.ucFirst(controllerName, preserveAfter: true));
  _controllerFile =
      _controllerFile.replaceAll('{CAMEL_SERVICE}', moduleName.toLowerCase());
  _controllerFile = _controllerFile.replaceAll(
      '{SERVICE}', Utils.ucFirst(moduleName, preserveAfter: true));
  ...
  /// Write File
  Utils.writeFile(
      "$controllerPath/${Utils.ucFirst(controllerName, preserveAfter: true)}Controller.dart",
      _controllerFile);

  /// Show Success message
  print(green(
      '"$controllerPath/${Utils.ucFirst(controllerName, preserveAfter: true)}Controller.dart" generated successfully.'));
}
